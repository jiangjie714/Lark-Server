...
@XmlRootElement(name = "getTechModelListService")
public class GetTechModelListService {

    @XmlElementRef(name = "xmlStr", namespace = "http://impl.webservice.dev.casic.com", type = JAXBElement.class, required = false)
