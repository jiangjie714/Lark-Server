package com.github.hollykunge.security.admin.redis.service.impl;
...
@Service
public class RedisDataBaseServiceImpl implements IRedisDataBaseService {
    private static final Logger LOGGER = Logger.getLogger(RedisDataBaseServiceImpl.class);

    @Resource(name = "dataBasePool")
