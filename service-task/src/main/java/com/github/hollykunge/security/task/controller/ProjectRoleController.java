...
public class ProjectRoleController {
    ...
    public ObjectRestResponse<Object> addRole(@RequestBody Object projectRole){
    ...
    public TableResultResponse<Object> findRole(@RequestParam("pageNum") Integer pageNum, @RequestParam("pageSize") Integer pageSize){
        return null;
    }
}
