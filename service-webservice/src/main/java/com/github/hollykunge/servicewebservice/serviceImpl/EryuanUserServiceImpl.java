...
//        adminUserVO.setPId(null);
    ...
    public void saveAdminOrg(EryuanOrg eryuanOrg,List orgVOList,StringBuilder ids){
        ...
        adminOrgVO.setPathCode(eryuanOrg.getPathCode());
        adminOrgVO.setPathName(eryuanOrg.getPathName());
//        adminOrgVO.setOrgCode(null);
    ...
    public void saveAllPath(){
        List<EryuanOrg> eryuanOrgs = eryuanOrgDao.selectAll();
        for (EryuanOrg eryuanOrg:eryuanOrgs) {
            if (eryuanOrg.getCASIC_PORG_CODE() == null) {
                eryuanOrg.setPathCode(eryuanOrg.getCASIC_ORG_CODE() + ".");
                eryuanOrg.setPathName(eryuanOrg.getORG_NAME() + "/");
            }
            else if (eryuanOrgDao.queryPathByCode(eryuanOrg.getCASIC_PORG_CODE()) == null && eryuanOrg.getCASIC_PORG_CODE() != null) {
                continue;
            }else {
                String pathByCode = eryuanOrgDao.queryPathByCode(eryuanOrg.getCASIC_PORG_CODE());
                String pathNameByCode = eryuanOrgDao.queryPathNameByCode(eryuanOrg.getCASIC_PORG_CODE());
                eryuanOrg.setPathCode(pathByCode + eryuanOrg.getCASIC_ORG_CODE() + ".");
                eryuanOrg.setPathName(pathNameByCode + eryuanOrg.getORG_NAME() + "/");
            }

            eryuanOrgDao.updateEryuanOrgInfo(eryuanOrg);
        }
    }
}
